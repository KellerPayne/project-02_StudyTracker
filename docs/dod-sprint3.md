...
- [ ] **Interactivity depth:** buttons, form inputs, timers all wired to app state.
- [ ] **Responsiveness:** confirmed desktop (>= 1280x720) and tablet (>= 768 px).
- [ ] **Accessibility and contrast:** light/dark themes readable.
- [ ] **Performance:** no console errors; Chart.js renders smoothly.
